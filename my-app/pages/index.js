    ...
    if (liquidityTab) {
      return (
        <div className={styles.tabSection}>
          ...
          <div className={styles.liquidityInputContainer}>
            ...
            {utils.parseEther(reservedCD.toString()).eq(zero) ? (
              <div className={styles.liquidityInputSection}>
                <input
                  type="number"
      ...
      return (
        <div className={styles.tabSection}>
          ...
          <br />
          <div className={styles.inputDiv}>
            {/* Convert the BigNumber to string using the formatEther function from ethers.js and round it to 2 decimal places*/}
            {ethSelected
              ? `You will get ${
                  Math.round(
                    utils.formatEther(tokenToBeReceivedAfterSwap) * 100
                  ) / 100
                } Crypto Dev Tokens`
              : `You will get ${
                  Math.round(
      ...
      <div className={styles.main}>
        <div className={styles.container}>
          ...
          <div className={styles.tabContainer}>
            <button
              className={liquidityTab ? styles.activeTab : styles.tab}
              onClick={() => {
            ...
            <button
              className={liquidityTab ? styles.tab : styles.activeTab}
              onClick={() => {
